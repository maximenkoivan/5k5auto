...
let timeOpen = parseInt($('#modal-promotion').attr('data-time-open'), 10);

if (timeOpen > 0) {
  setTimeout(function () {
    Fancybox.show([{ src: '#modal-promotion', type: 'inline' }]);
  }, timeOpen * 1000);
}
...
const finishData = {
  "quiz-1": {
    title: $('#ending-title-1')?.html(),
    text: $('#ending-text-1')?.html()
  },
  "quiz-2": {
    title: $('#ending-title-2')?.html(),
    text: $('#ending-text-2')?.html()
  },
  "quiz-3": {
    title: $('#ending-title-3')?.html(),
    text: $('#ending-text-3')?.html()
  },
  "quiz-4": {
    title: $('#ending-title-4')?.html(),
    text: $('#ending-text-4')?.html()
  }
};
